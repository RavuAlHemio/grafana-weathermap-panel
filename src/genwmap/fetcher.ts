...
export async function fetchMetrics(dataSources: { [index: string]: string; }, globalDataSourceName: string|GrafanaDataSource, metrics: PrometheusMetric[], lookback_interval: string): Promise<MetricValueMap> {
    // query
